...
static long syz_io_uring_setup(volatile long a0, volatile long a1, volatile long a2, volatile long a3, volatile long a4, volatile long a5)
{
	...
	*ring_ptr_out = (void*)syscall(__NR_mmap, vma1, ring_sz, 0x3, 0x8011, fd_io_uring, IORING_OFF_SQ_RING);

	uint32 sqes_sz = setup_params->sq_entries * SIZEOF_IO_URING_SQE;
	*sqes_ptr_out = (void*)syscall(__NR_mmap, vma2, sqes_sz, 0x3, 0x8011, fd_io_uring, IORING_OFF_SQES);
